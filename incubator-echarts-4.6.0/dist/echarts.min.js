...
(function(global, factory) {
  ...
  Object.assign(echarts, {
    init: function(...args) {
      let instance = init.apply(echarts, args),
      ...
      Object.assign(instance, {
        setOption: function(...args) {
          ...
          setTimeout(() => {
            series.forEach(({ showSymbolAfterAnimation }, index) => {
              if(!showSymbolAfterAnimation) return false;
              let { delay=0, symbolType='emptyCircle' } = showSymbolAfterAnimation;
              setTimeout(() => {
                series[index].symbol = symbolType;
                setOption.call(instance, { animationDuration:0, series });
              }, delay);
            });
          }, animationDuration / 1.6);
          setOption.apply(instance, args);
        }
      });
      return instance;
    }
